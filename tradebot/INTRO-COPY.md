# Dexvra Trade Bot — Introduction Copy

Ready-to-use marketing copy for [@Dexvratradebot](https://t.me/Dexvratradebot).
Every claim here maps to a shipped feature in [`README.md`](README.md) — if a
feature changes, change the line here too.

**Handles used throughout:** Website `dexvra.io` · Telegram `@Dexvralisting` ·
Bot `@Dexvratradebot` · X `@Dexvraio`
