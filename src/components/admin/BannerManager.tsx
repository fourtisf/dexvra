...
const SLOT_OPTIONS = [
  ...
  { key: "wide", label: "Wide Banner", size: "1022 × 115", hint: "Fills the row on its own. Tagged “Ad · Wide”." },
  { key: "standard", label: "Standard Banner", size: "728 × 90", hint: "Shares the row with one other. Tagged “Ad · Standard”." },
];
