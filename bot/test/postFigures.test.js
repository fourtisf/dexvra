...
test("BOTH fulfilment paths report the artwork, from the buffer the banner gets", () => {
  ...
  const fetchAt = Math.max(src.lastIndexOf("await fetchLogoUrlX(", watchAt), src.lastIndexOf("await fetchLogoUrlWarm(", watchAt), src.lastIndexOf("await readArtwork(", watchAt));
