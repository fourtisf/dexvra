...
const chainRow = [
  ...
  `<svg viewBox="0 0 24 24" width="26" height="26"><circle cx="12" cy="12" r="10" fill="#F3BA2F"/><g fill="#fff"><path d="M12 4.5 14.5 7 12 9.5 9.5 7z"/><path d="M7 9.5 9.5 12 7 14.5 4.5 12z"/><path d="M17 9.5 19.5 12 17 14.5 14.5 12z"/><path d="M12 14.5 14.5 17 12 19.5 9.5 17z"/><path d="M12 9.5 14.5 12 12 14.5 9.5 12z"/></g></svg>`,
